...
- Create Angular project with ng: `ng new angularhomepage.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angularhomepage.client.esproj`).
